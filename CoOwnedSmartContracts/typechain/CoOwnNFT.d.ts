...
interface CoOwnNFTInterface extends ethers.utils.Interface {
  functions: {
    "Properties(uint256)": FunctionFragment;
    "addProperty(string,string,string,uint256,uint256)": FunctionFragment;
...
export class CoOwnNFT extends BaseContract {
  ...
  functions: {
    Properties(
      ...
      [BigNumber, BigNumber, string, BigNumber, BigNumber, boolean] & {
        propertyNo: BigNumber;
        totalFractions: BigNumber;
        lister: string;
        pricePerFraction: BigNumber;
        fractionsLeft: BigNumber;
    ...
    addProperty(
      ...
      _pricePerFraction: BigNumberish,
